...
class CatalogController extends Controller
{
    ...
    public function getIndex(){
        ...
        return view('catalog.catalog')->with('peliculas',$this->arrayPeliculas);
    }
    public function getShow($id){

        return view('catalog.show')->with('peliculas',$this->arrayPeliculas[$id])->with('pos',$id);
    ...
    public function getId($id){
        ...
        return view('catalog.create')->with('peliculas',$this->arrayPeliculas[$id]);
    }
